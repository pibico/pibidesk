...
function switch_on(name, alias) {
  ...
  var straction = '';              
  if (name == 'fan-01-rpb3b-001'){
    straction="extractor_on"
  } else if (name == 'fan-02-rpb3b-001') {
    straction="calefactor_on"  
  } else if (name == 'pump-01-rpb3b-001') {
    straction="bomba_on"
  }
  ...
  frappe.confirm(
    ...
    function(){
      frappe.call({
        ...
        type: "GET",
        args: {"host": "rpb3b-001", "action": straction},
        error: function(r) {
...
function switch_off(name, alias) {
  ...
  var straction = '';
  if (name == 'fan-01-rpb3b-001'){
    straction="extractor_off"
  } else if (name == 'fan-02-rpb3b-001') {
    straction="calefactor_off"  
  } else if (name == 'pump-01-rpb3b-001') {
    straction="bomba_off"
  }
...
$('.toggle-switch').change(function(){
  if(!event.srcElement.checked) {
    ...
    var straction = '';
    if (btn.id == 'fan-01-rpb3b-001'){
      straction="extractor_off"
    } else if (btn.id == 'fan-02-rpb3b-001') {
      straction="calefactor_off"  
    } else if (btn.id == 'pump-01-rpb3b-001') {
      straction="bomba_off"
    }
