...
def manage_alert(sensor_var, uom, value, cmd, reason, datadate, doc):
  ...
  """.format(date_alert)
  message_html = """
  <p>This email is generated by Automatic Alarm Monitoring on pibiDesk.</p><br>
  <p>Site time: {}.</p><br>
  <p>You are receiving this email because your e-mail address is registered to receive alarms from pibiDesk. In case you no longer want to   receive them, go to admin view in pibiDesk and disable or remove yourself from the recipients channel.</p>
  """.format(date_alert)
